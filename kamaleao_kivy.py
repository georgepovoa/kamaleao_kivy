...
class KamaleãoApp(App):
    ...
    def build(self):
        ...
        def ver_tabela(instance):
            ...
            tabela_btt = GridLayout(cols=4, size_hint=(0.1, 0.5))
        ...
        Button_produção = Button(size_hint=(None, None), height=75, width=150, background_normal="img/Produção.png")

        side_bar.add_widget(Button_produção)

        Button_estoque = Button(size_hint=(None, None), height=75, width=150,
                                background_normal="img/estoque.png")

        side_bar.add_widget(Button_estoque)

        Button_relatorios = Button(size_hint=(None, None), height=75, width=150,
                                   background_normal="img/relatórios.png")

        side_bar.add_widget(Button_relatorios)

        Button_settings = Button(size_hint=(None, None), height=75, width=150,background_normal="img/settings.png")
        ...
        ###### menu #######
        menu = GridLayout(cols=3, padding=[150, 150, 10, 10], spacing=50)
        ...
        menu_forms_btt = Button(background_normal='img/Gerenciar.png', color=(0, 0, 0, 0), pos_hint={"x": 1, "y": 1},
